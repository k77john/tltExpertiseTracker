...
import { Button, DropdownInputField, Header, InputField, Switchtabs } from "../../components";
...
const ManageSubCategories = () => {
  ...
  const [currentCategoryTab, setCurrentCategoryTab] = useState<string>(cateogryTabs.new);
      ...
      <div className="bg-white-color rounded-lg border border-secondary-color">
        <div className="flex flex-col">
            ...
            {Object.values(cateogryTabs).map(tab => (
              <button
                ...
                className={`py-2 px-4 text-xs font-medium rounded-md ${
                  currentCategoryTab === tab ? "bg-primary-color text-white" : "bg-white-color text-body-text-color"
                }`}
          ...
          <div className="flex flex-col gap-4 p-4">
            <h4 className="text-base text-black-color font-semibold">{currentCategoryTab}</h4>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-4 md:flex-row">
                  <InputField
                    ...
                    width="65%"
                  />
                  <Switchtabs label="Status" onClick={(value) => setStatus(value)} tabValues={statusTabs} value={status} />
                </div>
                <div className="flex flex-col gap-4">
                  <InputField
                    label="Description"
                ...
                <div className="flex justify-end">
                  <Button width="15%" title="Submit" onClick={() => {}} />
                </div>
              </div>
            )}
