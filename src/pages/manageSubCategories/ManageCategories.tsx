...
import { Button, DropdownInputField, Header, InputField } from "../../components";
...
const ManageSubCategories = () => {
  ...
  const [currentSubCategoryTab, setSubCurrentCategoryTab] = useState<string>(subCateogryTabs.new);
      ...
      <div className="bg-white-color rounded-lg border border-light-gray-color">
        <div className="flex flex-col">
            ...
            {Object.values(subCateogryTabs).map(tab => (
              <button
                ...
                className={`py-2 px-4 text-xs font-medium rounded-md ${
                  currentSubCategoryTab === tab ? "bg-primary-color text-white-color" : "bg-white-color text-body-text-color"
                }`}
          ...
          <div className="flex flex-col gap-4 p-4">
            <h4 className="text-base text-black-color font-semibold">{currentSubCategoryTab}</h4>
